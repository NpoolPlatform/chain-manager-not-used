...
[![Test](https://github.com/NpoolPlatform/chain-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/chain-manager/actions/workflows/main.yml)
...
* make chain-manager ```单独编译服务```
* make chain-manager-image ```单独生成服务镜像```
