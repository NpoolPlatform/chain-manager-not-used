...
const (
	...
	// FieldFeedSource holds the string denoting the feed_source field in the database.
...
var (
	...
	// DefaultFeedSource holds the default value on creation for the "feed_source" field.
