...
func (cfu *CurrencyFeedUpdate) SetFeedSource(s string) *CurrencyFeedUpdate {
	cfu.mutation.SetFeedSource(s)
	return cfu
}

// SetNillableFeedSource sets the "feed_source" field if the given value is not nil.
func (cfu *CurrencyFeedUpdate) SetNillableFeedSource(s *string) *CurrencyFeedUpdate {
	if s != nil {
		cfu.SetFeedSource(*s)
	}
	return cfu
...
func (cfu *CurrencyFeedUpdate) ClearFeedSource() *CurrencyFeedUpdate {
	cfu.mutation.ClearFeedSource()
	return cfu
}
...
func (cfu *CurrencyFeedUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cfu.mutation.FeedSource(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
	...
	if cfu.mutation.FeedSourceCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: currencyfeed.FieldFeedSource,
		})
...
// SetFeedSource sets the "feed_source" field.
func (cfuo *CurrencyFeedUpdateOne) SetFeedSource(s string) *CurrencyFeedUpdateOne {
	cfuo.mutation.SetFeedSource(s)
	return cfuo
}

// SetNillableFeedSource sets the "feed_source" field if the given value is not nil.
func (cfuo *CurrencyFeedUpdateOne) SetNillableFeedSource(s *string) *CurrencyFeedUpdateOne {
	if s != nil {
		cfuo.SetFeedSource(*s)
	}
	return cfuo
}

// ClearFeedSource clears the value of the "feed_source" field.
func (cfuo *CurrencyFeedUpdateOne) ClearFeedSource() *CurrencyFeedUpdateOne {
	cfuo.mutation.ClearFeedSource()
	return cfuo
}
...
func (cfuo *CurrencyFeedUpdateOne) sqlSave(ctx context.Context) (_node *CurrencyFeed, err error) {
	...
	if value, ok := cfuo.mutation.FeedSource(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: currencyfeed.FieldFeedSource,
	...
	if cfuo.mutation.FeedSourceCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: currencyfeed.FieldFeedSource,
		})
