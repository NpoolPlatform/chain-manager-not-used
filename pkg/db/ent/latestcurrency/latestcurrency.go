...
const (
	// Label holds the string label denoting the latestcurrency type in the database.
	Label = "latest_currency"
	...
	// Table holds the table name of the latestcurrency in the database.
	Table = "latest_currencies"
)

// Columns holds all SQL columns for latestcurrency fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
