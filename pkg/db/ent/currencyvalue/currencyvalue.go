...
const (
	// Label holds the string label denoting the currencyvalue type in the database.
	...
	// FieldFeedSourceID holds the string denoting the feed_source_id field in the database.
	FieldFeedSourceID = "feed_source_id"
	...
	// Table holds the table name of the currencyvalue in the database.
	Table = "currency_values"
)

// Columns holds all SQL columns for currencyvalue fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	// DefaultFeedSourceID holds the default value on creation for the "feed_source_id" field.
	DefaultFeedSourceID func() uuid.UUID
